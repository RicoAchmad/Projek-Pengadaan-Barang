...
<div class="panel panel-default col-md-9">
    <div class="panel-heading"><span class="col-sm-10"><h4> Form Tambah Barang</h4></span>
        <a href="" class="btn btn-default float-right col-sm-2"><span class="fa fa-arrow-left">&nbsp;</span> Kembali</a>
    </div>
